    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prep_time', models.PositiveIntegerField(verbose_name='Preparation time')),
                ('total_time', models.PositiveIntegerField(verbose_name='Total time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='recipes.tag')),
            ],
            options={
                'verbose_name': 'tag Translation',
                'db_table': 'recipes_tag_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master')},
